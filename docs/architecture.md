...
- `groupPollingFilesByRunFolder` рекурсивно группирует выбранные JSON по ближайшей папке `YYYY-MM-DD_HH-MM-SS`; `ingestPollingFolderTree` обрабатывает группы хронологически и изолирует ошибки файлов.
