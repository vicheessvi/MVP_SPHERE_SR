(function (global) {
  ...
  function createPollingPlan(currentState, input) {
    ...
    if (managementTasks.length && !projection.managementEligibleDevices.length) errors.push("Среди выбранных устройств нет Huawei TE30, TE40, TE50 или TE60 с поддержкой закрытия HTTP и Telnet");
