...
- [x] T011 [US3] Выполнить controlled live TE30/TE50/TE60 validation по `quickstart.md` при наличии устройств
...
- T011 закрыта пользовательским подтверждением корректных опросов реальных TE30/TE50/TE60; чувствительные результаты остаются только на локальном компьютере.
