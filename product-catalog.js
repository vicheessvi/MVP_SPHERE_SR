(function (root, factory) {
  ...
  const MODULE_CATALOG = deepFreeze([
    ...
    },
    {
      ...
      summary: "Импортирует выгрузку SR, результаты опросов и файл учётных данных.",
      details: "Все операции выполняются локально. Повторная выгрузка SR обновляет актуальный перечень без удаления истории.",
    ...
    },
    {
      ...
      summary: "Показывает размер, фактический предел и применённые меры защиты.",
      details: "Прикладного ограничения объёма нет; предел определяется свободным местом и возможностями локальной файловой системы.",
      keywords: ["шифрование", "размер", "хранилище"]
    },
    {
