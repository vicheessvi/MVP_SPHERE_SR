(function (root, factory) {
  ...
  const MODULE_CATALOG = deepFreeze([
    ...
    },
    {
      ...
      details: "Каждая вложенная папка YYYY-MM-DD_HH-MM-SS становится отдельным запуском; JSON находятся рекурсивно, а ошибки отдельных файлов не отменяют корректные результаты. Все данные остаются в памяти текущей вкладки.",
